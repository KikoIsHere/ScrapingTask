...
A web scraping application using the Scrapy Framework to extract the newest 20 articles on /press/news-overview/ and an API to display the data that was scraped using the FastAPI framework and SQLalchemy.
